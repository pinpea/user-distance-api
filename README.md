...
Uses the bpdts-test-app API and returns users who are either listed as living in a given city or whose current location is within a requested number of miles of that city. I also implemented this project in [TypeScript](https://github.com/pinpea/user-distance-api-ts).
